...
connect_bd_intf_net [get_bd_intf_pins slave_0/S_AXI] [get_bd_intf_pins axi4_master_0/M00_AXI]
	...
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins slave_0/S_AXI_ACLK] [get_bd_pins axi4_master_0/M00_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins slave_0/S_AXI_ARESETN] [get_bd_pins axi4_master_0/M00_AXI_ARESETN]
	...
	set offset_file "${bd_path}/axi4_master_v1_0_tb_include.vh"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/axi4_master_v1_0_tb.v
